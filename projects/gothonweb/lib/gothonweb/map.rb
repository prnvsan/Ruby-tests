module Map
 ...
 var =  [
  ...
  MODIFIED_DEATH = Room.new("death",  var[rand(0..(var.length - 1))])

  THE_BRIDGE.add_paths({
    'throw the bomb' => MODIFIED_DEATH,
    'slowly place the bomb' => ESCAPE_POD
  })

 CODE = '#{rand(1..9)}#{rand(1..9)}#{rand(1..9)}'
  
  LASER_WEAPON_ARMORY.add_paths({CODE => THE_BRIDGE,
  '*' => MODIFIED_DEATH})

  CENTRAL_CORRIDOR.add_paths({'shoot!' => MODIFIED_DEATH,
  'dodge!' => MODIFIED_DEATH, 'tell a joke' => LASER_WEAPON_ARMORY})
